...
<h1 style="color: #003CFF; text-align: left; line-height: 50px; font-size: 18px; padding-left: 10px;"><a href="?xem=phimmoicapnhat">PHIM MỚI CẬP NHẬT</a></h1>
<?php
	//include('./modules/content/poster.php');
	$tp = array();
	$tp['tmp'] = $phimmoicapnhat;
