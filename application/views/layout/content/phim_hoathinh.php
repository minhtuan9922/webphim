...
<h1 style="color: #003CFF; text-align: left; line-height: 50px; font-size: 18px; padding-left: 10px;"><a href="?xem=phimhoathinh">PHIM HOẠT HÌNH</a></h1>
<?php
	$tp = array();
	$tp['tmp'] = $phim_hoathinh;
